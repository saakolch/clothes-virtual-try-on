### Определяет сложную архитектуру нейронной сети, в частности U²-Net, 
### которая представляет собой модель глубокого обучения, используемую в основном для задач сегментации изображений
